...
def run(cases=10000,novelty_tail=1000,seed=883):
 ...
 with tempfile.TemporaryDirectory() as td:
  ...
  return {'source_fingerprint':source_fingerprint(),'schema':'ikant-static-stress/v0.1','seed':seed,'cases':cases,'novelty_tail':novelty_tail,'nodes':len(rt.nodes),'relations':len(rt.relations),'events':rt.graph['seq'],'status':'PASS'}
