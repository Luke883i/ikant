...
class ProductConvergenceV29Tests(unittest.TestCase):
 ...
 def test_pwa_bumps_for_s10bis(self):self.assertIn('ikant-s10bis-bootstrap-v1',(ROOT/'ikant/web/sw.js').read_text())
