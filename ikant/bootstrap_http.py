...
def make_bootstrap_handler(service,pairing,*,assets_dir:Path,allowed_hosts:frozenset[str],expected_port:int):
 ...
 class Handler(Base):
  def _composed_asset(self,name):
   ...
   files=(assets_dir/'app.js',assets_dir/'epistemic.js',assets_dir/'bootstrap.js') if name=='app.js' else (assets_dir/'styles.css',assets_dir/'epistemic.css',assets_dir/'bootstrap.css')
