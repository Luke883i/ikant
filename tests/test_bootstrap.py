...
class Bootstrap(unittest.TestCase):
 def test_manifest(self):
  ...
  self.assertEqual(b['contract_version'],'0.10.0');self.assertEqual(a['contract_version'],'0.10.0')
  self.assertEqual(project['version'],'0.10.0a1');self.assertEqual(ikant.__version__,'0.10.0a1')
  ...
  be=b['active_human_egress'];ae=a['active_human_egress'];self.assertTrue(be['exclusive']);self.assertTrue(ae['exclusive_human_output'])
