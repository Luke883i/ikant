...
def main():
    ...
    p=cmd([sys.executable,'scripts/surface_a_stress.py','--cases','1500' if a.quick else '10000','--seed','883']);r=parsed(p);g['surface_a_stress']={'ok':r.get('status')=='PASS','result':r}
