...
from .invariants_runtime_v030 import S15BIS_INVARIANTS,S16_INVARIANTS,S16BIS_INVARIANTS,S17_INVARIANTS

_INVARIANTS=_legacy.invariants()+S15BIS_INVARIANTS+S16_INVARIANTS+S16BIS_INVARIANTS+S17_INVARIANTS
