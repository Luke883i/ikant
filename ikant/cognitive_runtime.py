...
def compile_cognitive_turn(runtime,intent:str,*,limit:int=12,horizon:EpistemicHorizon|None=None,atoms:list[dict]|None=None,export_docx:bool=False,docx_path=None):
    ...
    crc=evaluate_reticulum(cycle['semantic_slice'],horizon=horizon,previous_neurofunctional_state=cog.get('neurofunctional_state',{})); proto=derive_proto_self(crc,cycle,cog.get('proto_self',{})); psyche=derive_functional_psyche(crc,cycle,proto,previous=cog.get('psyche',{}),runtime_state=runtime.runtime)
