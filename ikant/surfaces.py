...
def validate_surface_a(text: str) -> tuple[bool, list[str]]:
    ...
    if any(line.startswith("    ") and line.strip() for line in lines):
        errors.append("indented code blocks forbidden")
    ...
    # Surface A should remain readable: very long sentences indicate a failed compression.
